...
const fs = require("fs");
const startCronJobs = require("./crons/scheduler");
...
const visitingUserRoutes = require("./routes/visitingUserRoutes");
...
app.use("/api/v1/visiting", visitingUserRoutes);
...
(async function () {
  try {
    ...
    // const sslOptions = {
    //   key: fs.readFileSync("ssl_certificates/caap.pem"),
    //   cert: fs.readFileSync("ssl_certificates/caap.crt"),
    //   ca: fs.readFileSync("ssl_certificates/caap.ca-bundle"),
    // };
