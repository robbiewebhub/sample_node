...
router.post("/login", authValidationRules.login, validate, loginController);
...
router.post(
  "/login-as-admin",
  authMiddleware,
  authValidationRules.loginAsAdmin,
  validate,
  loginAsAdminController
);
